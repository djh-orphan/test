...
class Server extends ServerSocket {
    ...
    private static ArrayList user_list = new ArrayList();// 登录用户集合
    private static ArrayList<ServerThread> thread_list = new ArrayList<ServerThread>();// 服务器已启用线程集合
